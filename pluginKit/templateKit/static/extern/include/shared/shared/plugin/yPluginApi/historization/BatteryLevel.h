...
{   
   ...
   public:
      ...
      //-----------------------------------------------------
      CBatteryLevel(const std::string& keywordName, const EMeasureType& measureType = EMeasureType::kAbsolute, typeInfo::CIntTypeInfo & additionalInfo = typeInfo::CIntTypeInfo::Empty);
