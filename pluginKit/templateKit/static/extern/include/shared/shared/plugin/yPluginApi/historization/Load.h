...
namespace shared { namespace plugin { namespace yPluginApi { namespace historization
{
   ...
   public:
      ...
      //-----------------------------------------------------
      CLoad(const std::string& keywordName, const EKeywordAccessMode& accessMode = EKeywordAccessMode::kGet, typeInfo::CDoubleTypeInfo & additionalInfo = typeInfo::CDoubleTypeInfo::Empty);
