...
IMPLEMENT_PLUGIN(CTemp)

CTemp::CTemp()
   : m_deviceName("Temp"), m_configuration(new CConfiguration()),
...
void CTemp::doWork(boost::shared_ptr<yApi::IYPluginApi> context)
{
   try
   {
      YADOMS_LOG(information) << "CTemp is starting...";
      ...
      // the main loop
      YADOMS_LOG(information) << "CTemp plugin is running...";
   ...
   {
      YADOMS_LOG(information) << "CTemp is stopping..." << std::endl;
   }
}

void CTemp::declareDevice(boost::shared_ptr<yApi::IYPluginApi> context)
{
...
void CTemp::onUpdateConfiguration(boost::shared_ptr<yApi::IYPluginApi> context, const shared::CDataContainer& newConfigurationData)
{
